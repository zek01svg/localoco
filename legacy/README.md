> **REFERENCE ONLY** — This is the old LocaLoco application, kept as read-only
> reference for behavior and data models during the rewrite. Do not modify it;
> it is not part of any build, lint, format, or test lane.
