    ...
    return (
      ...
      >
        <div className="flex gap-4">
          <div className={`p-3 rounded-full ${getTypeColor(notification.type)} flex-shrink-0`}>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-1">
              ...
              {!notification.read && (
                <Badge className="bg-primary text-white hover:bg-primary text-xs flex-shrink-0">New</Badge>
              )}
            </div>
          ...
          <div className="flex flex-col gap-2 flex-shrink-0">
            {!notification.read && (
              <Button
                ...
                className={isDarkMode ? 'hover:bg-white/10' : ''}
              >
            ...
            <Button
              ...
              className={isDarkMode ? 'hover:bg-white/10 text-destructive' : 'text-destructive'}
            >
    ...
    >
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-8">
        ...
        <Tabs defaultValue="all" className="w-full">
          <TabsList 
            className="mb-6"
            style={{ backgroundColor: isDarkMode ? '#2a2a2a' : undefined }}
          >
            <TabsTrigger 
              value="all"
              className={isDarkMode ? 'data-[state=active]:bg-[#3a3a3a] data-[state=active]:text-white text-gray-400' : ''}
            >
          ...
          <TabsContent value="unread">
            {unreadNotifications.length > 0 ? (
              ...
              <Card className="p-12 text-center" style={{ backgroundColor: cardBg, color: textColor }}>
                ...
                <h3 className="mb-2">No unread notifications</h3>
                <p className="text-muted-foreground">You've read everything!</p>
              </Card>
            )}
          </TabsContent>
        </Tabs>
