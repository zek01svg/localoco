      ...
      >
        ...
        >
          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <line x1="10%" y1="65%" x2="90%" y2="65%" stroke="#94A3B8" strokeWidth="4" />
            <line x1="45%" y1="10%" x2="45%" y2="90%" stroke="#94A3B8" strokeWidth="4" />
            <line x1="58%" y1="10%" x2="58%" y2="90%" stroke="#94A3B8" strokeWidth="4" />
            
            {/* Parks/Green Spaces */}
            <circle cx="30%" cy="30%" r="8%" fill="#86EFAC" opacity="0.3" />
            <circle cx="70%" cy="35%" r="6%" fill="#86EFAC" opacity="0.3" />
            <circle cx="65%" cy="75%" r="7%" fill="#86EFAC" opacity="0.3" />
