    ...
    <div className="min-h-screen md:pl-6" style={{ backgroundColor: bgColor }}>
      ...
      <div className="max-w-5xl mx-auto p-6 space-y-8">
        ...
        <Card className={`p-8 shadow-lg ${borderColor}`} style={{ backgroundColor: cardBgColor }}>
          <h2 className={`mb-6 ${textColor}`}>Start a New Discussion</h2>
              ...
              <div key={discussion.id} className={`space-y-4 pb-6 border-b last:border-b-0 ${borderColor}`}>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    <div>
                      <p className={textColor}>{discussion.userName}</p>
                      <h3 className={textColor}>{discussion.title}</h3>
                      {discussion.businessTag && (
                        <p className="text-sm text-primary">{discussion.businessTag}</p>
                      )}
                    </div>
                    <p className={mutedTextColor}>{discussion.content}</p>
                    
                    <div className={`flex items-center gap-4 text-sm ${mutedTextColor}`}>
                      <button
