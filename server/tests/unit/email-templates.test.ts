...
import { renderPasswordResetEmail, renderVerificationEmail } from "#server/lib/email/templates";
...
describe("renderVerificationEmail", () => {
  ...
  it("uses fallback name 'there' when name is null or undefined", () => {
    ...
    expect(rendered.html).toContain("Hi there, thanks for joining LocaLoco!");
